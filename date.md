<div id="date-range-picker" className="flex items-center" data-rangepicker>
...
implement the below features in the above datepicker code 
autohide after selecting date : 
...
max and min date :
use today date as min date and 6 months will be max date
